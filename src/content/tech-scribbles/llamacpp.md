...
Tests - at *2026-02-03*.
Refs: [UnSloth Docs](https://unsloth.ai/docs/models/qwen3-how-to-run-and-fine-tune#llama.cpp-run-qwen3-tutorial), [GGUF repo](https://huggingface.co/unsloth/Qwen3-8B-GGUF/tree/main).
