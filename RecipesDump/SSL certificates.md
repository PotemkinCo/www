...
as resolved [[2026-03-21]], and per [Perplexity ref](https://www.perplexity.ai/search/i-need-wildcard-ssl-certificat-XerW1wyvQ6moWPoPURB3AA):
...
> `openssl x509 -noout -text -in ssl-complete-bundle.crt` will only show first certificate and stop there. Here is a nice [ChatGPT transcript](https://chatgpt.com/c/6887c0d9-1d94-8323-b38b-38e562b4873c) on that.
