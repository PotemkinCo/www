LiveKit useful info is a at [[2025-11-29]]
...
- [Request id tracking functionality](https://www.perplexity.ai/search/element-x-keep-sync-for-too-lo-olBusn_hQcOfomnjLXZ6tQ)
...
mas-cli manage register-user --yes alex_p
...
UPDATE users SET admin=1 WHERE name='@alex:matrix.example.com'
...
```
alias mas-cli='docker compose run mas'
mas-cli --config /data/config.yaml manage issue-compatibility-token --yes-i-want-to-grant-synapse-admin-privileges alex
```
