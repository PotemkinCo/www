...
```
check program disk_health with path "/home/alex/tools/disk_health.sh"
    every 120 cycles
...
#check host cloudron-health-check with address my.foobar.com
#   if failed
#        port 443
#        protocol https
#        request "/api/v1/cloudron/status"
#        status = 200
        # content = "Hello World"
#   then alert
...
The key is for 20 servers (from 2023-08-06), order #6297.

MMonit `mmonit/conf/license.xml`:
```xml
<License owner="Alex Potemkin">
